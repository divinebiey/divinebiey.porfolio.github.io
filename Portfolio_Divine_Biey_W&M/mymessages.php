...
<body>
    ...
    <ul>
        ...
        <li>Name: <?php echo $item['sender']; ?><br>Email: <?php echo $item['email']; ?><br>Message: <?php echo $item['message']; ?><br>Findme: <?php echo $item['findme']; ?><br>Date: <?php echo (new Datetime($item['added_on']))->format('d-m-Y H:i:s'); ?></li>
